import 'package:first_flutter_app/map/quakes_map_app/util/types_helper.dart';
...
class Properties {
  ...
  Properties.fromJson(Map<String, dynamic> json) {
    ...
    place = json['place'];
    time = TypeHelper.topInt(json['time']);
    updated = TypeHelper.topInt(json['updated']);
    tz = TypeHelper.topInt(json['tz']);
    url = json['url'];
    detail = json['detail'];
    felt = TypeHelper.topInt(json['felt']);
    cdi = TypeHelper.toDouble(json['cdi']);
    mmi = TypeHelper.toDouble(json['mmi']);
    alert = json['alert'];
    status = json['status'];
    tsunami = TypeHelper.topInt(json['tsunami']);
    sig = TypeHelper.topInt(json['sig']);
    net = json['net'];
    code = json['code'];
    ids = json['ids'];
    sources = json['sources'];
    types = json['types'];
    nst = TypeHelper.topInt(json['nst']);
    dmin = TypeHelper.toDouble(json['dmin']);
    rms = TypeHelper.toDouble(json['rms']);
    gap = TypeHelper.topInt(json['gap']);
